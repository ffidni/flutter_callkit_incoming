...
fun addCall(context: Context?, data: Data, isAccepted: Boolean = false, isCallBack: Boolean = false, isMissed: Boolean = false) {
    ...
    if(currentData != null) {
        ...
        currentData.isCallBack = isCallBack
        currentData.isMissed = isMissed
    }else {
        arrayData.add(data)
    }
